# existing-mono-central-port-ingress-noautodeploy-20250812114933
...
```
docker build -t existing-mono-central-port-ingress-noautodeploy-20250812114933:latest .
docker run -p:5030:9999 existing-mono-central-port-ingress-noautodeploy-20250812114933:latest
```
